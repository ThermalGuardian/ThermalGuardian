...
sys.path.append('/home/ise/jsonDL')
...
class LeNetEnv:
    ...
    def __init__(self):
        ...
        tf_model = ModelJSON('./tf_resnet-20.json')
        torch_model = ModelJSON('./torch_resnet-20.json')
        ...
        with open('./tf_resnet-20.json', 'r') as f:
...
if __name__ == '__main__':
    ...
    activations = ['ReLU', 'ReLU6', 'SeLU', 'Sigmoid', 'Tanh']
    ...
    while True:
        ...
        # layer 0
        conv2d_1 = network[0]['params']
        rand1 = random.randint(16, 32)
        conv2d_1['out_channels'] = rand1
        conv2d_1['kernel_size'] = random.randint(1, 7)
        # layer 1
        batch_norm_1 = network[1]['params']
        batch_norm_1['num_features'] = rand1
        # layer 2
        activation_1 = network[2]
        activation_1['name'] = activations[random.randint(0, 4)]
        # layer 3
        conv2d_2 = network[3]['params']
        conv2d_2['in_channels'] = rand1
        conv2d_2['out_channels'] = rand1
        conv2d_2['kernel_size'] = random.randint(1, 7)
        # layer 4
        batch_norm_2 = network[4]['params']
        batch_norm_2['num_features'] = rand1
        # layer 5
        activation_2 = network[5]
        activation_2['name'] = activations[random.randint(0, 4)]
        # layer 6
        conv2d_3 = network[6]['params']
        conv2d_3['in_channels'] = rand1
        conv2d_3['out_channels'] = rand1
        conv2d_3['kernel_size'] = random.randint(1, 7)
        # layer 7
        batch_norm_3 = network[7]['params']
        batch_norm_3['num_features'] = rand1
        # layer 8
        activation_3 = network[8]
        activation_3['name'] = activations[random.randint(0, 4)]
        # layer 9
        conv2d_4 = network[9]['params']
        conv2d_4['in_channels'] = rand1
        rand2 = random.randint(32, 64)
        conv2d_4['out_channels'] = rand2
        conv2d_4['kernel_size'] = random.randint(1, 7)
        # layer 10
        batch_norm_4 = network[10]['params']
        batch_norm_4['num_features'] = rand2
        # layer 11
        activation_4 = network[11]
        activation_4['name'] = activations[random.randint(0, 4)]
        # layer 12
        conv2d_5 = network[12]['params']
        conv2d_5['in_channels'] = rand2
        conv2d_5['out_channels'] = rand2
        conv2d_5['kernel_size'] = random.randint(1, 7)
        # layer 13
        batch_norm_5 = network[13]['params']
        batch_norm_5['num_features'] = rand2
        # layer 14
        activation_5 = network[14]
        activation_5['name'] = activations[random.randint(0, 4)]
        # layer 15
        conv2d_6 = network[15]['params']
        conv2d_6['in_channels'] = rand2
        rand3 = random.randint(64, 128)
        conv2d_6['out_channels'] = rand3
        conv2d_6['kernel_size'] = random.randint(1, 7)
        # layer 16
        batch_norm_6 = network[16]['params']
        batch_norm_6['num_features'] = rand3
        # layer 17
        activation_6 = network[17]
        activation_6['name'] = activations[random.randint(0, 4)]
        # layer 18
        conv2d_7 = network[18]['params']
        conv2d_7['in_channels'] = rand3
        conv2d_7['out_channels'] = rand3
        conv2d_7['kernel_size'] = random.randint(1, 7)
        # layer 19
        batch_norm_7 = network[19]['params']
        batch_norm_7['num_features'] = rand3
        # layer 20
        activation_7 = network[20]
        activation_7['name'] = activations[random.randint(0, 4)]
        # layer 21
        avg_pool_1 = network[21]
        dice = random.uniform(0, 1)
        if dice <= 0.5:
            avg_pool_1['name'] = 'GlobalMaxPool2d'
        # layer 22
        dense_1 = network[22]['params']
        dense_1['in_features'] = rand3
        ...
        try:
            ...
            tf_phased_train = tf_train(tf_model.network, optimizer, "CrossEntropy", ln.epochs,
                                       ln.batch_size, ln.tf_dataset, shuffle=False, show_iter=False)
            torch_phased_train = torch_train(torch_model.network, optimizer, "CrossEntropy", ln.epochs,
                                             ln.batch_size, ln.torch_dataset, shuffle=False, show_iter=False)
