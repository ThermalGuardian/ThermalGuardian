...
class RemoveCameraInvisiblePointsKITTI(TransformABC):
    """
    Remove camera invisible points for kitti_dataset_root dataset.
    """
...
class RemoveCameraInvisiblePointsKITTIV2(TransformABC):
    """
    Remove camera invisible points for kitti_dataset_root dataset, unlike `RemoveCameraInvisiblePointsKITTI` which projects image plane to a frustum,
